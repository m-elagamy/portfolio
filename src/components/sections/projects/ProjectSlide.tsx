      ...
      <div className="flex flex-col gap-8 text-start">
        ...
        <ul className="flex flex-wrap items-center gap-2">
          {project.techs.map((tech) => (
            <li
              className="flex items-center gap-1 rounded bg-gray-700 px-2 py-1 text-sm text-gray-200"
              key={tech.techName}
            >
              <img
                src={tech.techImage}
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="flex items-center justify-center gap-1 rounded-lg bg-gray-700 px-4 py-2 text-white hover:bg-gray-800"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
