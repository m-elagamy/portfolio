...
const Header = ({ isScrolled }: { isScrolled: boolean }) => {
  ...
  return (
    <motion.header
      className={`fixed left-0 right-0 top-4 z-50 mx-auto max-w-sm rounded-full py-1 drop-shadow-lg backdrop-blur md:max-w-[700px] lg:max-w-3xl ${isScrolled && scrollY > 600 ? "bg-gradient-to-r from-gray-800/80 to-gray-700/70 shadow-md" : "bg-transparent"}`}
